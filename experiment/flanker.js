...
var flanker_instructions = {
    ...
    stimulus:`
    <h2><b>Middle Arrow Orientation Game</b></h2>
        <p>In this game, you will see <b>5 arrows</b> presented on the screen, such as like this:</p>
        <p align="center"
        <figure>
        <img src = "images/flanker_example.png" width = 30%"/>
        </figure>
        <p>Your job is to respond based on the <b>direction</b> of the MIDDLE arrow, ignoring the surrounding arrows:</p>
        </p>
...
var flanker_begin = {
    ...
    <h2><b style="color: #10db10;">Main Task</b></h2>
        ...
        <p><i>Again</i>, in this game, you will see <b>5 arrows</b> presented on the screen, such as like this:</p>
        <p align="center"
        <figure>
        <img src = "images/flanker_example.png" width = 30%"/>
        </figure>
        ...
        <p>In this game of speed and reflex, consisting of several rounds, you will need to select the correct response according to the <b>direction of the middle arrow</b> as fast and as correctly as possible, while <b>resisting the surrounding arrows</b>.</p>
        <br>
        <p>Press "Continue" to start the experimental trials. Each round will begin with a <b>3-2-1</b> countdown.</p>
    `
}
